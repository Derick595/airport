...
const SPCChart = {
  ...
  updateTheme() {
    ...
    const grid = light ? "rgba(100, 116, 139, 0.22)" : "rgba(51, 65, 85, 0.4)";
    this.chart.options.scales.x.grid.color = grid;
    this.chart.options.scales.yVib.grid.color = grid;
    this.chart.options.scales.x.ticks.color = light ? "#475569" : "#94a3b8";
    this.chart.options.scales.yVib.ticks.color = light ? "#0e7490" : "#06b6d4";
    this.chart.options.scales.yTemp.ticks.color = light ? "#1d4ed8" : "#3b82f6";
    this.chart.options.plugins.legend.labels.color = light ? "#334155" : "#cbd5e1";
    this.chart.data.datasets[0].borderColor = light ? "#0e7490" : "#06b6d4";
    this.chart.data.datasets[1].borderColor = light ? "#1d4ed8" : "#3b82f6";
